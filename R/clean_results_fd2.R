...
clean_results_fdm2 <- function(file){
...
# Features to add
#
# features <- c("odds_closing_max_last_exact_fixture_result_home",
#               "odds_closing_max_last_exact_fixture_result_draw",
#               "odds_closing_max_last_exact_fixture_result_away",
#               "odds_closing_median_last_exact_fixture_result_home",
#               "odds_closing_median_last_exact_fixture_result_draw",
#               "odds_closing_median_last_exact_fixture_result_away")
